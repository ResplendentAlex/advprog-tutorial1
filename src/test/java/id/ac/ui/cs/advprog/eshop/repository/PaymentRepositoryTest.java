...
public class PaymentRepositoryTest {
    ...
    void setUp() {
        ...
        this.codPaymentData.put("address", "Citra 1 Ext. Blok AB-3 No.1");
    ...
    void testAddInvalidPaymentMethod() {
        assertThrows(IllegalArgumentException.class, () -> {
            paymentRepository.addPayment(order1, "GOPAY", new HashMap<String, String>());
        });
    }
    ...
    void testInvalidVoucherPaymentData() {
        ...
        paymentDataWithLessThanSixteenCharacters.put("voucherCode", "ESHOP1234AB5678");
